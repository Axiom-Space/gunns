...
LIBRARY DEPENDENCY:
    (
     ...
     (software/exceptions/TsUnknownException.o)
...
void ConstantPowerLoad::calculateConstantPowerLoad()
{
    ...
    if (mMalfOverrideCurrentFlag) {
        ...
        case LoadSTANDBY:  // In Standby Operation
            ...
            break;
        default:
            TS_HS_EXCEPTION(TS_HS_FATAL, TS_HS_EPS, " Load operation mode is an invalid value.",
                            TsUnknownException, "ConstantPowerLoad::calculateConstantPowerLoad", mNameLoad);
        }
        computeActualPower();
    }
}
