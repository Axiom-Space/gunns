#ifndef UtGunnsFluidHotAdsorber_EXISTS
#define UtGunnsFluidHotAdsorber_EXISTS

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @defgroup UT_TSM_GUNNS_FLUID_SOURCE_HOT_ADSORBER   Hot Adsorber Unit Tests
...
#include "aspects/fluid/source/GunnsFluidHotAdsorber.hh"

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief    Inherit from GunnsFluidHotAdsorber and befriend UtGunnsFluidHotAdsorber.
///
/// @details  Class derived from the unit under test. It just has a constructor with the same
///           arguments as the parent and a default destructor, but it befriends the unit test case
///           driver class to allow it access to protected data members.
////////////////////////////////////////////////////////////////////////////////////////////////////
class FriendlyGunnsFluidHotAdsorber : public GunnsFluidHotAdsorber
{
    public:
        FriendlyGunnsFluidHotAdsorber();
        virtual ~FriendlyGunnsFluidHotAdsorber();
        friend class UtGunnsFluidHotAdsorber;
};
inline FriendlyGunnsFluidHotAdsorber::FriendlyGunnsFluidHotAdsorber() : GunnsFluidHotAdsorber() {};
inline FriendlyGunnsFluidHotAdsorber::~FriendlyGunnsFluidHotAdsorber() {}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
class UtGunnsFluidHotAdsorber: public CppUnit::TestFixture
{
    public:
        /// @brief    Default constructs this Adsorber unit test.
        UtGunnsFluidHotAdsorber();
        /// @brief    Default constructs this Adsorber unit test.
        virtual ~UtGunnsFluidHotAdsorber();
    ...
    private:
        CPPUNIT_TEST_SUITE(UtGunnsFluidHotAdsorber);
        ...
        double                            mEfficiencyBias;        /**< (1/K)   Bias for the dependency of efficiency on temperature. */
        double                            mEfficiencyScaleFactor; /**< (--)    Scale factor for the dependency of efficiency on temperature. */
        GunnsFluidHotAdsorberConfigData*  mConfigData;            /**< (-)     Pointer to nominal configuration data. */
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        UtGunnsFluidHotAdsorber(const UtGunnsFluidHotAdsorber&);
        ////////////////////////////////////////////////////////////////////////////////////////////
        /// @details  Assignment operator unavailable since declared private and not implemented.
        ////////////////////////////////////////////////////////////////////////////////////////////
        UtGunnsFluidHotAdsorber& operator =(const UtGunnsFluidHotAdsorber&);
};
