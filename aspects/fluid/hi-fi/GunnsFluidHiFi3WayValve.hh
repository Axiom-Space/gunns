...
class GunnsFluidHiFi3WayValveConfigData : public GunnsFluidLinkConfigData
{
    public:
        ...
        GunnsFluidHiFi3WayValveConfigData(const std::string&                                name                  = "",
                                          ...
                                          const GunnsFluidHiFiOrificeConfigData::CoeffTypes coefficientTypeA      = GunnsFluidHiFiOrificeConfigData::CoeffTypes::DISCHARGE_COEFF,
                                          const GunnsFluidHiFiOrificeConfigData::CoeffTypes coefficientTypeB      = GunnsFluidHiFiOrificeConfigData::CoeffTypes::DISCHARGE_COEFF,
