...
LIBRARY DEPENDENCY:
 ((aspects/fluid/conductor/GunnsFluidHiFiValve.o))
***************************************************************************************************/
...
#include <algorithm>
#include "GunnsFluidHiFiCheckValve.hh"
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GunnsFluidHiFiCheckValveConfigData::GunnsFluidHiFiCheckValveConfigData(const std::string& name,
                                                                       GunnsNodeList*     nodes,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GunnsFluidHiFiCheckValveConfigData::GunnsFluidHiFiCheckValveConfigData(const GunnsFluidHiFiCheckValveConfigData& that)
    :
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GunnsFluidHiFiCheckValveConfigData::~GunnsFluidHiFiCheckValveConfigData()
{
    // nothing to do
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GunnsFluidHiFiCheckValveInputData::GunnsFluidHiFiCheckValveInputData(const bool   malfBlockageFlag,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GunnsFluidHiFiCheckValveInputData::GunnsFluidHiFiCheckValveInputData(const GunnsFluidHiFiCheckValveInputData& that)
    :
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GunnsFluidHiFiCheckValveInputData::~GunnsFluidHiFiCheckValveInputData()
{
    // nothing to do
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GunnsFluidHiFiCheckValve::GunnsFluidHiFiCheckValve()
    :
    GunnsFluidHiFiValve(),
...
///                 input data.
////////////////////////////////////////////////////////////////////////////////////////////////////
void GunnsFluidHiFiCheckValve::initialize(const GunnsFluidHiFiCheckValveConfigData&  configData,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void GunnsFluidHiFiCheckValve::validate() const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void GunnsFluidHiFiCheckValve::restartModel()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void GunnsFluidHiFiCheckValve::updateState(const double dt)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void GunnsFluidHiFiCheckValve::setMalfStuck(const bool flag)
{
    mMalfStuckFlag = flag;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void GunnsFluidHiFiCheckValve::setMalfFailTo(const bool flag, const double value)
{
