#ifndef GunnsFluidValveController_EXISTS
#define GunnsFluidValveController_EXISTS
...
////////////////////////////////////////////////////////////////////////////////////////////////////
class GunnsFluidValveControllerConfigData : GunnsFluidValveConfigData
{
    public:
        ...
        GunnsFluidValveControllerConfigData(const std::string& name                 = "",
        ...
        GunnsFluidValveControllerConfigData(const GunnsFluidValveControllerConfigData& that);
        /// @brief    Default destructs this Valve Controller model configuration data.
        virtual ~GunnsFluidValveControllerConfigData();
    private:
        /// @brief    Assigns this Valve Controller model configuration data.
        GunnsFluidValveControllerConfigData& operator=(const GunnsFluidValveControllerConfigData& that);
};
...
///           model input data.
////////////////////////////////////////////////////////////////////////////////////////////////////
class GunnsFluidValveControllerInputData : GunnsFluidValveInputData
{
    public:
        ...
        GunnsFluidValveControllerInputData(const bool   malfBlockageFlag       = false,
        ...
        GunnsFluidValveControllerInputData(const GunnsFluidValveControllerInputData& that);
        /// @brief    Default destructs this Valve Controller model input data.
        virtual ~GunnsFluidValveControllerInputData();
    private:
        /// @brief    Assigns this Valve Controller model input data.
        GunnsFluidValveControllerInputData& operator =(const GunnsFluidValveControllerInputData& that);
};
...
////////////////////////////////////////////////////////////////////////////////////////////////////
class GunnsFluidValveController : GunnsFluidValve
{
    TS_MAKE_SIM_COMPATIBLE(GunnsFluidValveController);
    public:
        ...
        GunnsFluidValveController();
        /// @brief    Default destructs this Valve Controller model.
        virtual ~GunnsFluidValveController();
        /// @brief    Initializes this Valve Controller model.
        /// @callgraph
        void initialize(const GunnsFluidValveControllerConfigData& configData,
                        const GunnsFluidValveControllerInputData&  initData,
    ...
    protected:
        ...
        bool          mInitFlag;         /**<    (--) trick_chkpnt_io(**) Initialization complete flag. */
        /// @brief    Validates this Valve Controller model initialization data.
        void validate(const GunnsFluidValveControllerConfigData& configData,
                      const GunnsFluidValveControllerInputData&  initData) const;
    ...
    private:
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        GunnsFluidValveController(const GunnsFluidValveController&);
        ////////////////////////////////////////////////////////////////////////////////////////////
        /// @details  Assignment operator unavailable since declared private and not implemented.
        ////////////////////////////////////////////////////////////////////////////////////////////
        GunnsFluidValveController operator= (const GunnsFluidValveController&);
};
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline bool GunnsFluidValveController::isStuck() const
{
    return mStuckFlag;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline bool GunnsFluidValveController::isLowerLimit() const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline bool GunnsFluidValveController::isUpperLimit() const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline double GunnsFluidValveController::getPosition() const
{
    return mCmdPosition;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline double GunnsFluidValveController::getFluidPosition() const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline double GunnsFluidValveController::getMinPosition() const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline double GunnsFluidValveController::getMaxPosition() const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline void GunnsFluidValveController::setPosition(const double position)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline void GunnsFluidValveController::setManualPosition(const bool flag, const double value)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline bool GunnsFluidValveController::isInitialized() const
{
    return mInitFlag;
}
