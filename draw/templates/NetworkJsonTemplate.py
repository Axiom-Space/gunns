...
shapeMap = {
  ...
  'mxgraph.electrical.capacitors.capacitor_1': '<shape aspect="variable" h="60" name="Capacitor 1" strokewidth="inherit" w="100"><connections><constraint name="in" perimeter="0" x="0" y="0.5" /><constraint name="out" perimeter="0" x="1" y="0.5" /></connections><foreground><path><move x="0" y="30" /><line x="45" y="30" /><move x="55" y="0" /><line x="55" y="60" /><move x="45" y="0" /><line x="45" y="60" /><move x="55" y="30" /><line x="100" y="30" /></path><stroke /></foreground></shape>',
  ...
  'mxgraph.pid.fittings.funnel': '<shape aspect="variable" h="140" name="Funnel" strokewidth="inherit" w="80"><connections /><background><path><move x="40" y="40" /><line x="40" y="140" /><move x="0" y="0" /><line x="40" y="40" /><line x="80" y="0" /></path></background><foreground><stroke /></foreground></shape>',
  'mxgraph.pid.fittings.vent': '<shape aspect="variable" h="140" name="Vent" strokewidth="inherit" w="80"><connections /><background><path><move x="40" y="40" /><line x="40" y="140" /><move x="0" y="40" /><line x="40" y="0" /><line x="80" y="40" /></path></background><foreground><stroke /></foreground></shape>',
...
class NetworkJsonTemplate:
  ...
  def portPos(self, port):
    ...
    if style_map[node_str+'X']+','+style_map[node_str+'Y'] not in compass.keys(): print('ERROR: Port not connected properly to ' + link_name)
